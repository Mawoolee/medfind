...
final class PharmacyBackNavigationTest extends TestCase
{
    public function test_every_standalone_pharmacy_page_uses_the_shared_back_component_with_its_workflow_parent(): void
    {
        $expectedDestinations = [
            ...
            'controlled_substance_log.blade.php' => 'pharmacy.dashboard',
            'controlled_substances_index.blade.php' => 'pharmacy.dashboard',
            'cycle_counts_create.blade.php' => 'pharmacy.dashboard',
            'cycle_counts_index.blade.php' => 'pharmacy.dashboard',
            'cycle_counts_show.blade.php' => 'pharmacy.dashboard',
            'inventory.blade.php' => 'pharmacy.dashboard',
            'inventory_batches.blade.php' => 'pharmacy.dashboard',
            'inventory_create.blade.php' => 'pharmacy.dashboard',
            'inventory_edit.blade.php' => 'pharmacy.dashboard',
            'location_edit.blade.php' => 'pharmacy.dashboard',
            'messages.blade.php' => 'pharmacy.dashboard',
            'profile_edit.blade.php' => 'pharmacy.dashboard',
            'receiving_create.blade.php' => 'pharmacy.dashboard',
            'requirements.blade.php' => 'pharmacy.dashboard',
            'returns_create.blade.php' => 'pharmacy.dashboard',
            'returns_index.blade.php' => 'pharmacy.dashboard',
            'sales/create.blade.php' => 'pharmacy.dashboard',
            'suppliers_create.blade.php' => 'pharmacy.dashboard',
            'suppliers_edit.blade.php' => 'pharmacy.dashboard',
