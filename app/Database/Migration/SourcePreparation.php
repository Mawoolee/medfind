...
final class SourcePreparation
{
    ...
    public static function medFindSchemaPolicy(): array
    {
        $authoritative = [
            ...
            'controlled_substance_logs' => ['id', 'inventory_item_id', 'user_id', 'action', 'quantity', 'notes', 'logged_at', 'created_at', 'updated_at', 'operation_id'],
            ...
            'inventory_audits' => ['id', 'inventory_item_id', 'user_id', 'before_quantity', 'after_quantity', 'notes', 'created_at', 'updated_at', 'operation_id'],
