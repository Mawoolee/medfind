...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- Filters -->
    <form method="GET" action="{{ route('admin.activity') }}" class="bg-white rounded-xl shadow-lg p-4 mb-6 flex flex-col sm:flex-row flex-wrap gap-3 sm:items-end">
        <div>
            <label class="block text-sm font-semibold text-gray-600 mb-1">Action</label>
            <select name="action" class="w-full sm:w-auto border border-gray-300 rounded-xl px-3 py-2.5 text-base sm:text-sm focus:ring-2 focus:ring-purple-300 focus:border-purple-400">
        ...
        <div>
            ...
            <select name="entity" class="w-full sm:w-auto border border-gray-300 rounded-xl px-3 py-2.5 text-base sm:text-sm focus:ring-2 focus:ring-purple-300 focus:border-purple-400">
