...
<div class="flex items-center justify-between mb-6">
    ...
    <!-- Search & Filter -->
    <form method="GET" action="{{ route('admin.users') }}" class="bg-white rounded-xl shadow-lg p-4 mb-6 flex flex-col sm:flex-row flex-wrap gap-3 sm:items-end">
        ...
        <div>
            ...
            <select name="role" class="w-full sm:w-auto border border-gray-300 rounded-xl px-3 py-2.5 text-base sm:text-sm">
