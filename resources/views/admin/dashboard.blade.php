...
<div class="container mx-auto px-4 py-8">
 ...
 <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
 <div class="bg-white rounded-xl shadow-lg p-5 sm:p-6 flex flex-col">
 ...
 <a href="{{ route('admin.users') }}" class="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl transition duration-200 w-full sm:w-fit">
 ...
 <a href="{{ route('admin.pharmacies') }}" class="inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-xl transition duration-200 w-full sm:w-fit">
 ...
 <a href="{{ route('admin.requirements') }}" class="inline-flex items-center justify-center text-white px-6 py-3 rounded-xl transition duration-200 w-full sm:w-fit" style="background:#9400D3;">
