...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
        @foreach([
            ['label' => 'Total Medicines', 'value' => $inventoryCount, 'value_class' => 'text-blue-600', 'icon_class' => 'text-blue-200', 'icon' => 'fa-capsules'],
            ['label' => 'In Stock', 'value' => $inStockCount, 'value_class' => 'text-green-600', 'icon_class' => 'text-green-200', 'icon' => 'fa-check-circle'],
            ['label' => 'Total Messages', 'value' => $messageCount, 'value_class' => 'text-purple-600', 'icon_class' => 'text-purple-200', 'icon' => 'fa-envelope'],
            ['label' => 'Unread', 'value' => $unreadCount, 'value_class' => 'text-red-600', 'icon_class' => 'text-red-200', 'icon' => 'fa-envelope-open'],
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col"><h2 class="text-lg font-semibold text-gray-800 mb-2">Record Sale</h2><p class="text-gray-600 mb-4 flex-1">Record sold medicines and deduct eligible stock automatically by FEFO.</p><a href="{{ route('pharmacy.sales.create') }}" class="bg-sky-700 hover:bg-sky-800 text-white inline-flex items-center justify-center gap-2 text-center font-semibold px-6 py-3 rounded-lg transition duration-200 w-full min-h-12 whitespace-normal break-words leading-tight"><i class="fas fa-cart-shopping"></i>Record Sale</a></div>
        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col"><h2 class="text-lg font-semibold text-gray-800 mb-2">Manage Inventory</h2><p class="text-gray-600 mb-4 flex-1">View one aggregate row per medicine and monitor par levels.</p><a href="{{ route('pharmacy.inventory') }}" class="bg-blue-600 hover:bg-blue-700 text-white inline-flex items-center justify-center gap-2 text-center font-semibold px-6 py-3 rounded-lg transition duration-200 w-full min-h-12 whitespace-normal break-words leading-tight"><i class="fas fa-boxes-stacked"></i>Manage Inventory</a></div>
        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col"><h2 class="text-lg font-semibold text-gray-800 mb-2">Add New Medicine</h2><p class="text-gray-600 mb-4 flex-1">Create product identity without batch or stock details.</p><a href="{{ route('pharmacy.inventory.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white inline-flex items-center justify-center gap-2 text-center font-semibold px-6 py-3 rounded-lg transition duration-200 w-full min-h-12 whitespace-normal break-words leading-tight"><i class="fas fa-capsules"></i>Add Medicine</a></div>
        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col"><h2 class="text-lg font-semibold text-gray-800 mb-2">Add Stock / Receive Delivery</h2><p class="text-gray-600 mb-4 flex-1">Record every delivery as a separate traceable batch.</p><a href="{{ route('pharmacy.receiving.create') }}" class="bg-green-600 hover:bg-green-700 text-white inline-flex items-center justify-center gap-2 text-center font-semibold px-6 py-3 rounded-lg transition duration-200 w-full min-h-12 whitespace-normal break-words leading-tight"><i class="fas fa-truck-ramp-box"></i>Receive Delivery</a></div>
        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col"><h2 class="text-lg font-semibold text-gray-800 mb-2">View Stock Batches</h2><p class="text-gray-600 mb-4 flex-1">Review batches, lots, suppliers, expiry dates, and remaining stock.</p><a href="{{ route('pharmacy.inventory.batches') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white inline-flex items-center justify-center gap-2 text-center font-semibold px-6 py-3 rounded-lg transition duration-200 w-full min-h-12 whitespace-normal break-words leading-tight"><i class="fas fa-layer-group"></i>View Batches</a></div>
        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col"><h2 class="text-lg font-semibold text-gray-800 mb-2">Messages</h2><p class="text-gray-600 mb-4 flex-1">Respond to customer inquiries and prescription verification.</p><a href="{{ route('pharmacy.messages') }}" class="bg-purple-600 hover:bg-purple-700 text-white inline-flex items-center justify-center gap-2 text-center font-semibold px-6 py-3 rounded-lg transition duration-200 w-full min-h-12 whitespace-normal break-words leading-tight"><i class="fas fa-comments"></i>Messages @if($unreadCount > 0)<span class="ml-1 bg-red-500 text-xs rounded-full px-2 py-1">{{ $unreadCount }}</span>@endif</a></div>
        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col"><h2 class="text-lg font-semibold text-gray-800 mb-2">Audit Log</h2><p class="text-gray-600 mb-4 flex-1">Review correlated stock quantity changes.</p><a href="{{ route('pharmacy.audit-log') }}" class="bg-gray-700 hover:bg-gray-800 text-white inline-flex items-center justify-center gap-2 text-center font-semibold px-6 py-3 rounded-lg transition duration-200 w-full min-h-12 whitespace-normal break-words leading-tight"><i class="fas fa-history"></i>Audit Log</a></div>
        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col"><h2 class="text-lg font-semibold text-gray-800 mb-2">Stock Movement Log</h2><p class="text-gray-600 mb-4 flex-1">Record dispensing, wastage, and transfers.</p><a href="{{ route('pharmacy.controlled-substances.index') }}" class="bg-rose-600 hover:bg-rose-700 text-white inline-flex items-center justify-center gap-2 text-center font-semibold px-6 py-3 rounded-lg transition duration-200 w-full min-h-11">  <i class="fas fa-book"></i>View Logbook</a><a href="{{ route('pharmacy.controlled-substances.create') }}" class="mt-2 bg-rose-100 hover:bg-rose-200 text-rose-800 border border-rose-200 inline-flex items-center justify-center gap-2 text-center font-semibold px-6 py-3 rounded-lg transition duration-200 w-full min-h-12 whitespace-normal break-words leading-tight"><i class="fas fa-shield-halved"></i>Log Stock Movement</a></div>
    </div>
