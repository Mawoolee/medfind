    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <form action="{{ route('pharmacy.suppliers.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" required class="block w-full border border-gray-300 rounded px-3 py-2.5 text-base">
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Contact Person</label>
                <input type="text" name="contact_person" class="block w-full border border-gray-300 rounded px-3 py-2.5 text-base">
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Phone</label>
                <input type="text" name="phone" class="block w-full border border-gray-300 rounded px-3 py-2.5 text-base">
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                <input type="email" name="email" class="block w-full border border-gray-300 rounded px-3 py-2.5 text-base">
            </div>
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-1">Address</label>
                <textarea name="address" rows="3" class="block w-full border border-gray-300 rounded px-3 py-2.5 text-base"></textarea>
            </div>
